...
extern "C" {
    pub fn io_seproxyhal_ble_send_db();
}
extern "C" {
    pub fn io_seproxyhal_ble_pairing_db_from_mcu(
        mac_addr: *mut cty::c_uchar,
        mac_addr_len: cty::c_uint,
        db_offset: cty::c_uint,
        buffer: *mut cty::c_uchar,
        buffer_len: cty::c_uint,
    );
}
extern "C" {
    pub fn io_seproxyhal_ble_pairing_db_to_mcu(
        mac_addr: *mut cty::c_uchar,
        mac_addr_len: cty::c_uint,
        send_request: bolos_bool_t,
    ) -> bolos_bool_t;
}
extern "C" {
    pub fn io_ble_pairing_db_persist_request();
}
extern "C" {
